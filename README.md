...
Algorithm:
- ![\rho, \theta ](https://latex.codecogs.com/svg.image?\rho,&space;\theta) are discretized using the resolutions provided within the range $-d \le \rho \le d$, $d = \sqrt{w^2 + h^2}$ and $0 \le \theta < \pi$ respectively.
